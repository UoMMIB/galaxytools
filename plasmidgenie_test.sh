...
cd /local_tools/galaxytools/code/PlasmidGenieClient; python plasmid_genie/client.py https://ice.synbiochem.co.uk pablo.carbonell@manchester.ac.uk synbiochem2020 synbiochem /export/galaxy-central/database/files/000/dataset_99.dat /export/galaxy-central/database/files/000/dataset_108.dat MlyI
